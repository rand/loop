...
|---|---|---|---|---|---|---|---|
| `rlm-claude-code` | `2268cb0409d61bf0f4e4d15e83a74fd20cfd7100` | pinned `vendor/loop` = `6779cdbc970c70f3ce82a998d6dcda59cd171560` | Hard runtime/build vendoring (`rlm_core`) | `VG-RCC-001`, `VG-CONTRACT-001` | `evidence/2026-02-19/milestone-M4/M4-T04-VG-RCC-001.txt` | `supported` | Pin-aware scope only (D-008). Not a claim for `/Users/rand/src/loop` HEAD unless pin is updated and rerun. |
| `loop-agent` | active: `390f459f389933a948a785ad4c7554fa6ac7cb3d`; committed candidate: `f2aeb1859592ef82f63f6ae416973854c381666b` (`/tmp/loop-agent-clean`) | `/Users/rand/src/loop` runtime seam contract | Optional runtime seam (classifier + trajectory + sensitivity guardrails) | `VG-LA-001`, `VG-CONTRACT-001` | `evidence/2026-02-19/milestone-M6/loop-the-VG-LA-001.txt` | `supported` | `VG-LA-002` reached 3/3 green snapshots (`867 passed`) on committed candidate tuple, satisfying D-014+D-015 evidence criteria. Claim-grade cadence evidence is now constrained by D-017 to clean-clone committed tuple mode until canonical stabilization is complete. |
| `io-rflx` | `abf11ca4069bac7a740508d02242114483a6cf51` | schema-first interop with loop | `io_rflx_interop.v0` | `VG-RFLX-001`, `VG-CONTRACT-001` | `evidence/2026-02-19/milestone-M4/M4-T04-VG-RFLX-001.txt` | `supported` | Compile + contract validation scope, no hard compile-time loop dependency required. |
