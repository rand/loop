...
| M7-T10 spec/governance reconciliation and promotion (`loop-bih.10`) | done | M7-T09 | VG-DOC-SPEC-002, VG-CONTRACT-001, VG-RCC-001, VG-LA-001, VG-RFLX-001 | SPEC-20..27 status reconciliation with refreshed traceability and support claims |
