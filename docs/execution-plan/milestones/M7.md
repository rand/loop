...
- This milestone plan is historical execution context.
- M7 task cards are completed (`loop-bih.1..10` closed).
- Use `docs/execution-plan/STATUS.md` and Beads for live queue state.
...
- At planning time, G-001 and G-002 from `M3-T04-spec-test-traceability.md` were open.
